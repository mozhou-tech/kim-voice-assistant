...
class Mic:
    ...
    def __init__(self, profile, speaker, passive_stt_engine,
        ...
        passive_stt_engine -- performs STT while xiaoyun is in passive listen
                              mode
        acive_stt_engine -- performs STT while xiaoyun is in active listen
                            mode
        """
    ...
    def passiveListen(self, PERSONA):
        ...
        if transcribed is not None and any(PERSONA in phrase for phrase in transcribed):
